...
namespace Glacier.Core.Parser.AntlrDenter.AntlrDenter
{
    //Needed a deque so I made this quick wrapper
    static class DeqWrapper
    {
        public static void AddFront<T>(this Deque<T> deque, T item) 
            => deque.AddToFront(item);

        public static void AddBack<T>(this Deque<T> deque, T item) 
            => deque.AddToBack(item);

        public static T RemoveFront<T>(this Deque<T> deque) 
            => deque.RemoveFromFront();

        public static T Get<T>(this Deque<T> deque, int idx)
            => deque[idx];
    }
